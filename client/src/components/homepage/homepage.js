                ...
                <div className="header">
                    ...
                    <div className="home">
                        <img
                            ...
                            alt="vector-4"
                        />
                        <div className="place montserrat-bold-white-24px">
                            {place}
                        </div>
                    </div>
                    <div className="Auth">
                        <Link to="/signin">
                            <div className="sign-in montserrat-bold-white-24px">
                                {signIn}
                            </div>
                        </Link>
                        <Link to="/signup">
                            <div className="sign-up montserrat-bold-white-24px">
                                {signUp}
                            </div>
                        </Link>
                        <div className="contributor-section">
                            ...
                            <h1 class="contributor" id="name1">
                                Abcd.. Efgh...
                            </h1>
                            <span class="dot" id="dot2"></span>
                            <h1 class="contributor" id="name2">
                                Abcd.. Efgh.....
                            </h1>
                            <span class="dot" id="dot3"></span>
                            <h1 class="contributor" id="name3">
                                Abcd.. Efgh.............
                            </h1>
                            <span class="dot" id="dot4"></span>
                            <h1 class="contributor" id="name4">
                                Abcd... Efgh...
                            </h1>
                            <span class="dot" id="dot5"></span>
                            <h1 class="contributor" id="name5">
                                Abcd.... Efgh..
                            </h1>
                            <span class="dot" id="dot6"></span>
                            <h1 class="contributor" id="name6">
                                Abcd....... Efgh....
                            </h1>
                            <span class="dot" id="dot7"></span>
                            <h1 class="contributor" id="name7">
                                Abcd.. Efgh...
                            </h1>
                            <span class="dot" id="dot8"></span>
                            <h1 class="contributor" id="name8">
                                Abcd. Efgh...
                            </h1>
                            <span class="dot" id="dot9"></span>
                            <h1 class="contributor" id="name9">
                                Abcd.. Efg............
                            </h1>
                            <span class="dot" id="dot10"></span>
                            <h1 class="contributor" id="name10">
                                Abcd... Efgh
                            </h1>
                        </div>
                        <div className="landing-page-orange">
                            <div className="overlap-group">
                                ...
                                <h1 className="text-1 montserrat-bold-black-24px">
                                    {text1}
                                </h1>
                                <img
                                    className="vector-3"
                                ...
                                />
                                <div
                                    className="place montserrat-bold-white-24px"
                                    id="switchtoggle"
                                >
                                ...
                                <Link to="/notyet">
                                    <div className="group-9">
                                        <div className="overlap-group2">
                                            <div className="explore montserrat-bold-white-24px">
                                                <span>{explore}</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <Link to="/aboutus">
                                <div className="aboutus montserrat-bold-white-24px navbar">
                                    {aboutus}
                                </div>
                            </Link>
                            <Link to="/signin">
                                <div className="sign-in montserrat-bold-white-24px navbar">
                                    {signIn}
                                </div>
                            </Link>
                            <Link to="/signup">
                                <div className="group-8">
                                    <div className="overlap-group3 navbar">
                                        <div className="sign-up montserrat-bold-white-24px navbar">
                                            {signUp}
                                        </div>
