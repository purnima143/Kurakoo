...
export class Navbar extends Component {
  ...
  render() {
    return (
        ...
        //                     <a href="#home">
        //                         <img className="logo_kurakoo"
        //                           src="./images/kurakoo-logo.png" alt="kurakoo_logo"/>
        //                     </a>
        //                 </div>
        //             </div>
        ...
        //modified the navbar to be displayed in the Feed Page
        ...
        {/* <div className="logo_nav"> */}
                    ...
                    <div class="sign_nav"> 
                        ...
                        {/* <div className="btn_div"> */}
                            <button className="sign_in_btn"><b>Sign Out</b></button>
                        {/* </div> */}
                    </div>
        </nav>
    // </div>
